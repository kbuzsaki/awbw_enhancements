...
<div id="awbwhelper-sidebar-container" class="awbwhelper-sidebar-container">
  <div id="awbwhelper-sidebar-contents" class="awbwhelper-sidebar-contents">
...
class PlayersPanel {
    constructor(replayContainer, baseUrl, profileSettingsReader, players) {
        ...
        this.playersInfoPatchElement = document.getElementById("awbw_helper-playersInfo-patch");
