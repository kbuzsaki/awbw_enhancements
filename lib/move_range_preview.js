...
class MoveRangePreview {
    constructor(gamemap, terrainInfo, players) {
        ...
        this.lastClickedUnitSpan = undefined;
        this.rangeTiles = [];
    ...
    onClick(event) {
        if (event.target.id === "move") {
            ...
            let clickedUnitSpan = event.target.parentNode;
            if (this.lastClickedUnitSpan !== undefined) {
                this.clearMoveRange();
            } else {
                this.lastClickedUnitSpan = clickedUnitSpan;
    ...
    updateMoveRange() {
        ...
        for (let unit of this.units) {
            if (unit.element === this.lastClickedUnitSpan) {
                selectedUnit = unit;
                break;
            }
        }
