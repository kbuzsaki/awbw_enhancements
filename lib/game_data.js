...
const kUnitData = [
  ...
  {name: "md",         menuName: "Md.Tank",    cost: 16000, move: 5, move_type: "T", facility: "base"},
  {name: "mech",       menuName: "Mech",       cost: 3000,  move: 3, move_type: "B", facility: "base"},
...
const kTerrainIds = {
    ...
    "urban":    makeRange(34, 101).concat([111, 112]).concat(makeRange(117, 194)),
};
const kTerrainById = invertDict(kTerrainIds);

const kMoveCostByTerrain = {
    ...
    "urban":    {F: 1, B: 1, T: 1, W: 1, A: 1, P: 0, S: 0, L: 0},
};
