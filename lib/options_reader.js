    ...
    onOptionsReady(optionalCallback) {
        function loadOptionsWithCallback(callback) {
            ...
            chrome.storage.sync.get({
                ...
                options_bindings_forward_action: [74 /*j*/, 39 /*right*/],
                options_bindings_forward_turn:   [76 /*l*/, 40 /*down*/],
                ...
                options_enable_bugfix_broken_sonja_hp: true,
                options_enable_bugfix_missing_units_players_id: true,
                options_enable_bugfix_revealed_neutral_fog_buildings: true,
            }, (result) => {
