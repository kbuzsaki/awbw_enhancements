...
function templatePlayerOverviewBar(gameInfo, playerInfo, liveInfo) {
  ...
  let isPower = playerInfo.players_co_power_on === "P";
  let isSuper = playerInfo.players_co_power_on === "S";
  let powerHtml = isSuper ? kSuperHtml : (isPower ? kPowerHtml : "");
...
<div class="player-overview-bar">
  <div class="main-co-bar co-bar-container">
    ${powerHtml}
    <div class="power-bar" data-bar-pid="1299237" style="visibility: ${isPower || isSuper ? 'hidden' : 'visible'}">
