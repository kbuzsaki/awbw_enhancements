...
function templatePlayerHtml(playerInfo, liveInfo) {
  let playerOverview = templatePlayerOverview(playerInfo, liveInfo);
...
class PlayerPanel {
    ...
    generateHtml() {
        return templatePlayerHtml(this.playerInfo, this.liveInfo);
    }
