...
function templatePlayerOverviewCo(baseUrl, playerInfo, liveInfo) {
...
function templatePlayerUnitList(baseUrl, playerInfo, playerUnits) {
    let unitCounts = {};
    ...
    for (let unitId of kUnitNamesInMenuOrder) {
        ...
        let url = baseUrl + "/" + playerInfo.countries_code + unitId + ".gif";
...
function templatePlayerOverviewInfo(baseUrl, playerInfo, liveInfo, playerUnits) {
    let eliminated = liveInfo.eliminated;
    ...
    let unitListHtml = templatePlayerUnitList(baseUrl, playerInfo, playerUnits);
    return `
<div class="player-overview-info">
  <ul class="awbwhelper-${countryCode}-player-border">
    <!-- # of units -->
    <li class="player-overview-unit-count">
      <img src="${baseUrl}/${countryCode}infantry.gif">
...
function templatePlayerOverview(baseUrl, playerInfo, liveInfo, playerUnits) {
    let playerId = playerInfo.players_id;
    let username = playerInfo.users_username;
    let countryCode = playerInfo.countries_code;
    let eliminated = liveInfo.eliminated;
    let overviewCoHtml = templatePlayerOverviewCo(baseUrl, playerInfo, liveInfo);
    let overviewInfoHtml = templatePlayerOverviewInfo(baseUrl, playerInfo, liveInfo, playerUnits);
    return `
...
function templatePlayerOverviewBar(baseUrl, playerInfo, liveInfo) {
...
function templateEndTurnButton(baseUrl, playerInfo, liveInfo) {
...
function templatePlayerHtml(baseUrl, playerInfo, liveInfo, playerUnits) {
  let playerOverview = templatePlayerOverview(baseUrl, playerInfo, liveInfo, playerUnits);
  let playerBar = templatePlayerOverviewBar(baseUrl, playerInfo, liveInfo);
  let endTurnButton = templateEndTurnButton(baseUrl, playerInfo, liveInfo);
...
class PlayerPanel {
    constructor(parentPanel, baseUrl, playerInfo, endTurnCallback) {
    ...
    generateHtml() {
        return templatePlayerHtml(this.baseUrl, this.playerInfo, this.liveInfo, this.playerUnits);
    }
